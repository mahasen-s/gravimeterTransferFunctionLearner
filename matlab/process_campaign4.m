...
time_window     = 30*60;
data            = getDriftCorrection(data,time_window);

% Write to file
write_all_hdf5(data,subseqs,'./ChrisFreierPhDCampaigns/campaign4_proc_1000ms.h5')